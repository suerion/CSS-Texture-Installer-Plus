...
The v1.5.0 changes were primarily generated by OpenAI ChatGPT and are reviewed and tested by the repository maintainer. Human testing is still required before release.
...
- One-time backup of an existing `mountdepots.txt` as `mountdepots.txt.cssti-backup`.
